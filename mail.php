			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>33 Pooja Colony, Deep Nagar 2,Farshi Stop, Amravati</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="mailto:info@example.com">hello@imaginescript.com</a></span></li>
					</ul>
					<ul>
