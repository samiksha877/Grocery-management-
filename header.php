...
// header.php
if (!isset($conn)) {
    include 'dbcon.php'; // this file should define $conn = new mysqli(...)
}
?>
<meta charset="utf-8">
    <!-- for-mobile-apps -->
...
<body>
    ...
    <div class="agileits_header">
      <div class="w3l_offers"> <a href="#">GroceryPoint</a> </div>
  ...
  <div class="logo_products">
      <div class="container">
        <div class="w3ls_logo_products_left">
           <a href="index.php">
           <img src="images/grocery-logo.png" alt="Grocery Logo" class="logo-image">
      </a>
        </div>
        <div class="w3ls_logo_products_left1">
          <ul class="special_items">
            <li><a href="about.php" style="margin-right:20px;">About Us</a></li>
            <li><a href="services.php">Services</a></li>
          </ul>
        </div>
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone " style="margin-right:-40px"; aria-hidden="true"></i> <a href="tel:+919979331605">(+91) 9979331605</a></li>
            <li><i class="fa fa-envelope-o" style="margin-right:-40px"; aria-hidden="true"></i><a href="mailto:hello@imaginescript.com"> <a href="mailto:hello@imaginescript.com">hello@imaginescript.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
